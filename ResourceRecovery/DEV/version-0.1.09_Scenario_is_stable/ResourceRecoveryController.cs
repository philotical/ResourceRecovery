...
/*
    [KSPAddon(KSPAddon.Startup.EveryScene, false)]
    public class ResourceRecoveryController_installer : MonoBehaviour
    {
        internal void Awake()
        {
            if (FlightGlobals.ready)
            {
                Debug.Log("ResourceRecoveryController_installer Awake running");
...
*/
    ...
    public class ResourceRecoveryController_SpaceCentre : MonoBehaviour
    {
        ...
        private ConfigNode RRDATA = null;
        private bool run_once = false;
        //public static RecourceRecoveryData config = null;
