...
namespace Philotical
{
    class MarketplaceController
    {
        ...
        internal void MarketplaceMain(int id)
        {
            //Scenario = RRDATAcontroller;
            ...
            string kred_string = ScenarioAttributes.get_ScenarioAttribute("SaveGameKredits");
        ...
        */
        ...
        private void BuyResource(string res_nam, double price, double buyAmount)
        {
            ...
            ConfigNode res = RRDATAcontroller.get_ResourceNode(res_nam);
            ...
            if (RRDATAcontroller.modify_ResourceNode_by_ResourceName(res_nam, "storedamount", new_storage_amount.ToString()))
            {
                ScenarioAttributes.set_ScenarioAttribute("SaveGameKredits", new_Kredit.ToString());
            }
