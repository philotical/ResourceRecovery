...
namespace Philotical
{
    public class ButtonController
    {
        ...
        public static void GetResourceOptionsButtons(List<string> buttonIDs, Part part, PartResource resource, string resourceSelected, ScenarioNodeDatabase Sc)
        {
            GUIStyle buttonStyle = RRSettingsController.get_button_stretchWidth();
            foreach (string bid in buttonIDs)
            {
                if (GUILayout.Button(bid, buttonStyle))
                {
                    ...
                    Utilities.perform_resource_transfer(bid, part, resource, resourceSelected, Sc);
                }
            }
        }
