...
namespace Philotical
{
    ...
    public class ResourceRecoveryData : ScenarioModule
    {
        ...
        public override void OnSave(ConfigNode config)
        {
            ...
            config.SetValue("version", ScenarioAttributes.get_ScenarioAttribute("version"));
