...
/// My first part!
/// </summary>
public class ResourceRecoveryPlanetCore : PartModule
{
    /// <summary>
...
{
    public static class PlanetCorePartConfigNode
    {
        public static ConfigNode PartConfig = null;
        static PlanetCorePartConfigNode()
        {
        }
        public static ConfigNode get_PlanetCorePartConfig()
        {
            //Debug.Log("ResourceRecovery Foo get_PartConfig PartConfig=" + PartConfig);
            return PartConfig;
        }
        public static void set_PlanetCorePartConfig(ConfigNode foo)
        {
            PartConfig = foo;
        }
    }
    ...
    public class ResourceRecoveryPlanetCore : PartModule
    {
         ...
         * Serialization a lot.
         */
        public ResourceRecoveryPlanetCore()
        {
            Debug.Log("ResourceRecoveryPlanetCore [" + this.GetInstanceID().ToString("X")
        ...
        public override void OnLoad(ConfigNode node)
        {
            ...
            PlanetCorePartConfigNode.set_PlanetCorePartConfig(node);
        }
