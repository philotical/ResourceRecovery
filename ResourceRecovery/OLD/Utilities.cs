...
namespace Philotical
{
    public class Utilities
    {
        ...
        public static string GetDllVersion(ResourceRecovery thisObject)
        {
            string ver;
            ver = Assembly.GetAssembly(typeof(ResourceRecovery)).GetName().Version.ToString();
            return ver;
        }
        ...
        public static double ShowTextField(double currentValue, GUIStyle style, params GUILayoutOption[] options)
        {
            double newDouble;
            int maxLength = 2000;
